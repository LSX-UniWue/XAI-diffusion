    ...
    class Block(nn.Module):
        ...
        def forward(self, x: Tensor) -> Tensor:
            ...
            if self.skip_connection:
                x = x_input + x
            return torch.stack([x, emb], dim=2)
...
class MLPDiffusion(nn.Module):
    def __init__(self, d_in, num_classes, is_y_cond, rtdl_params, dim_t=128, category_sizes=None):
        super().__init__()
        self.dim_t = dim_t
